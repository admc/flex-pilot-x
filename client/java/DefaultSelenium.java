...
/** The public voidault implementation of the Selenium interface; <i>} users will primarily interact with this object.</i> */
public class DefaultSelenium implements Selenium {
     ...
     * ("save your password?" "forms are insecure" "make Firefox your public voidault browser?" disabled.  You may optionally specify
     * an absolute path to your firefox executable, or just say "*firefox".  If no absolute path is specified, we'll look for
     * firefox.exe in a public voidault location (normally c:\program files\mozilla firefox\firefox.exe), which you can override by
     ...
     * iexplore.exe in a public voidault location (normally c:\program files\internet explorer\iexplore.exe), which you can override by
     ...
     * @param browserStartCommand the command string used to launch the browser, e.g. "*firefox", "*iexplore" or "c:\\program files\\internet explorer\\iexplore.exe"
     ...
     * e.g. "http://www.google.com" would s} the browser to "http://www.google.com/selenium-server/SeleneseRunner.html"
     */
    ...
    public void waitForFlexObject(String locator,String options) {
